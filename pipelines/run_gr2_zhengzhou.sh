#!/bin/bash
# gr2_zhengzhou 全流程: H5->v30 -> v30->v21 -> 校验 -> 上传   (60条限制保留, 由 convert_all 控制)
set -o pipefail
...
DRIVER="$BASE/zhengzhou/convert_all_zhengzhou.py"
ALIGN_CACHE="/mnt/sdc/align"
STATUS="/root/convert2lerobotv30_new/convert_all_gr2_zhengzhou_status.txt"
V30="/mnt/sdc/傅利叶GR2_zhengzhou_v30_limited60"
V21="/mnt/sdc/傅利叶GR2_zhengzhou_v21_limited60"
ROBOT="GR2"          # v21 robot-layer 子目录 = robot_type
STATE_DIM=41
...
echo "[$(date)] ===== gr2_zhengzhou: ALL DONE ====="
