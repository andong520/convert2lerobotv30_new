#!/bin/bash
# gr2 全流程: H5->v30 -> v30->v21 -> 校验 -> 上传   (60条限制保留, 由 convert_all 控制)
set -o pipefail
...
DRIVER="$BASE/shanghai/convert_all_gr2.py"
ALIGN_CACHE="/mnt/sdc/align_gr2_sh"
STATUS="/root/convert2lerobotv30_new/convert_all_gr2_shanghai_status.txt"
V30="/mnt/sdc/傅利叶GR2_shanghai_v30_limited60"
V21="/mnt/sdc/傅利叶GR2_shanghai_v21_limited60"
