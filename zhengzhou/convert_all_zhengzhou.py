...
if __name__ == "__main__":
    ...
    robot_type = "傅利叶GR2"
    output_base_path = '/mnt/sdc/傅利叶GR2_zhengzhou_v30_limited60'


    # 转换脚本路径
    CONVERT_SCRIPT = "/root/convert2lerobotv30_new/align_scripts/gr2_align2lerobot_v30_no_norm.py"
    ...
    # 创建状态日志文件（支持resume模式）
    log_file_path = '/root/convert2lerobotv30_new/convert_all_gr2_zhengzhou_status.txt'
