...
if __name__ == "__main__":
    ...
    sheet_name = "模型内部需求"
    robot_type = "方舟无限arx-acone"
    output_base_path = '/mnt/sdc/arx_loong_shanghai_v30_limited60'
    # 转换脚本路径
    CONVERT_SCRIPT = "/root/convert2lerobotv30_new/align_scripts/arx_align2lerobot_v30_no_norm.py"
    ...
    # 创建状态日志文件（支持resume模式）
    log_file_path = '/root/convert2lerobotv30_new/convert_all_arx_shanghai_status.txt'
