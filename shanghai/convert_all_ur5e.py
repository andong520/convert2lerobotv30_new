...
if __name__ == "__main__":
    ...
    # 转换脚本路径
    CONVERT_SCRIPT = "/root/convert2lerobotv30_new/align_scripts/ur5e_align2lerobot_v30_no_norm.py"
    ...
    # 创建状态日志文件（支持resume模式）
    log_file_path = '/root/convert2lerobotv30_new/convert_all_ur5e_shanghai_status.txt'
