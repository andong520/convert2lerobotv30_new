...
if __name__ == "__main__":
    ...
    rclone_config = '/root/.config/rclone/rclone.conf'
    local_base_path = '/mnt/sdc/align_cobotmagic'
    ...
    robot_type = "松灵Aloha"
    output_base_path = '/mnt/sdc/cobotmagic_shanghai_v30_limited60'
    # 转换脚本路径
    CONVERT_SCRIPT = "/root/convert2lerobotv30_new/align_scripts/aloha_align2lerobot_v30_no_norm.py"
    ...
    # 创建状态日志文件（支持resume模式）
    log_file_path = '/root/convert2lerobotv30_new/convert_all_cobotmagic_shanghai_status.txt'
