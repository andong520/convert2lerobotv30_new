...
if __name__ == "__main__":
    ...
    rclone_config = '/root/.config/rclone/rclone.conf'
    local_base_path = '/mnt/sdc/align_leju'

    excel_path = "/root/convert2lerobotv30_new/数据转换第三批次20260513 .xlsx"
    sheet_name = "模型内部需求-上海"
    robot_type = "乐聚KUAVO"
    output_base_path = '/mnt/sdc/lejukuafu_shanghai_v30_limited60'
    # 转换脚本路径
    ...
    # 创建状态日志文件（支持resume模式）
    log_file_path = '/root/convert2lerobotv30_new/convert_all_leju_shanghai_status.txt'
