...
if __name__ == "__main__":
    ...
    rclone_config = '/root/.config/rclone/rclone.conf'
    local_base_path = '/mnt/sdc/align_astribot'

    excel_path = "/root/convert2lerobotv30_new/数据转换第三批次20260513 .xlsx"
    sheet_name = "模型内部需求-上海"
    robot_type = "星尘智能S1"
    output_base_path = '/mnt/sdc/astribots1_shanghai_v30_limited60'
    # 转换脚本路径
    CONVERT_SCRIPT = "/root/convert2lerobotv30_new/align_scripts/astribot_s1_align2lerobot_v30_no_norm.py"
    ...
    # 创建状态日志文件（支持resume模式）
    log_file_path = '/root/convert2lerobotv30_new/convert_all_astribots1_shanghai_status.txt'
